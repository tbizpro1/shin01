...
const TotalNewClientsCard = ({ data, enterprise  }) => {
    ...
    getMetricsCompany(token)
        ...
        if (response && Array.isArray(response)) {
            ...
            if (metric && metric.new_clients !== undefined) {
                lastValidValue = Number(metric.new_clients);
            ...
            <Card>
                <Card.Body style={{ padding: "0" }}>
                    <div className="header header_helper">
                        ...
                        <h5 className="m-b-0">{latestMetric?.new_clients?.toLocaleString()}</h5>
